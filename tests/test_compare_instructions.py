...
class ProcessorTest(unittest.TestCase):
    ...
    def test_compare_accumulator_immediate_detects_equal(self):
        test_compare_instruction(instruction=[CMP_IMMEDIATE, 0xf0],  register_data={'A': 0xf0}, n=0, z=1, c=1, 
                             num_cycles=2)
    def test_compare_accumulator_immediate_detects_register_smaller_unsigned(self):
        test_compare_instruction(instruction=[CMP_IMMEDIATE, 0xf0],  register_data={'A': 0xd0}, n=1, z=0, c=1, 
                             num_cycles=2)
    def test_compare_accumulator_immediate_detects_register_smaller_signed(self):
        test_compare_instruction(instruction=[CMP_IMMEDIATE, 0x1],  register_data={'A': 0xd0}, n=1, z=0, c=0, 
                             num_cycles=2)
