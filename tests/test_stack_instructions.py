...
def test_pull_processor_status_instruction(instruction:list[int], num_cycles:int, data={}, register_data:dict={}, flags:dict={}) -> None:
    processor = setup_processor(instruction, data=data, registers=register_data)
...
class ProcessorTest(unittest.TestCase):
    ...
    def test_pull_accumulator(self):
        test_pull_accumulator_instruction([PLA], value=0x42, num_cycles=4, register_data={'SP': 0xfe}, data={0x01ff:0x42})
    ...
    def test_pull_processor_status(self):
        test_pull_processor_status_instruction([PLP], num_cycles=4, register_data={'SP': 0xfe}, data={0x01ff: 0b11000111}, 
