...
\begin{xltabular}{\linewidth}{@{}ccX@{}}
  \caption{Statusflags\label{tab:flags}}\\\toprule
    ...
    0 & \texttt{C} & Das \emph{Carry}-Flag signalisiert einen Übertrag bei der letzten arithmetisch-logischen Operation. 
...
\begin{xltabular}{\linewidth}{@{}p{25mm}Xl@{}}
  ...
  \textbf{\sffamily Indirect}\newline \ind & Indirekte Adressierung
             ...
             Es wird mit zwei Bytes eine Speicherstelle angegeben, wo die
...
% LocalWords:  Adressierungsmodus Indexregister
