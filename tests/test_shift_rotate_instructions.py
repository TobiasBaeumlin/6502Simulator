...
class ProcessorTest(unittest.TestCase):
    ...
    def test_shift_memory_left_zero_page(self):
        test_shift_memory_instruction([ASL_ZERO_PAGE, 0x0], address=0x0, value=0b11000001, left=True, num_cycles=5,
         data={0x0:0b11000001})
    ...
    def test_rotate_memory_left_zero_page(self):
        test_rotate_memory_instruction([ROL_ZERO_PAGE, 0x0], address=0x0, value=0b11000001, left=True, num_cycles=5,
         data={0x0:0b11000001}, flags_data={'C': True})
